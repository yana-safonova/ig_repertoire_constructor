...
if __name__ == "__main__":
    ...
    #                             which=[i],
    #                             kinds=["igrec_tau3_f03", "mixcr2", "supernode"], labels=["IgReC", "MiXCR2", "pRESTO"],
    #                             legend=False)
    ...
    plot_various_error_rate(igrec_dir + "/various_error_rate", what="sensitivity", out="sensitivity",
                            ...
                            kinds=["igrec", "mixcr2", "supernode"], labels=["IgReC", "MiXCR2", "pRESTO"])
    ...
    plot_various_error_rate(igrec_dir + "/various_error_rate", what="sensitivity", out="sensitivity_woans", woans=True,
                            ...
                            kinds=["igrec_tau3", "mixcr2", "supernode"], labels=["IgReC", "MiXCR2", "pRESTO"])
