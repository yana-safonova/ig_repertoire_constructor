...
void JRecombinationEventGenerator::GenerateCleavageEvents(
        const alignment_utils::ImmuneGeneReadAlignment &j_alignment,
        recombination_utils::IgGeneRecombinationEventStorage &j_events) const
{
...
recombination_utils::IgGeneRecombinationEventStorage JRecombinationEventGenerator::ComputeEvents(
        const alignment_utils::ImmuneGeneReadAlignment &j_alignment) const
{
    recombination_utils::IgGeneRecombinationEventStorage j_events(germline_utils::SegmentType::JoinSegment);
    TRACE(j_alignment.Alignment());
    // generation of palindromic events
    TRACE("Generation of palindromic events");
