...
def parse_command_line():
    ...
    parser.add_argument('-o', '--output_filename', type=prepare_output_directory,
                        ...
                        required=True)
    parser.add_argument('-k', '--k_mer_length', type=check_kmer_length,
...
def main():
    ...
    # for alignment in shm_substitution_model_estimator.alignments:
    #     print(alignment.read.seq)
    #     print(alignment.germline_seq.seq)
