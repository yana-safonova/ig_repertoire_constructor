...
public:
    ...
    void set_read(const std::string::const_iterator &begin, const std::string::const_iterator &end)
    { read_germline_pair_.first.assign<std::string::const_iterator>(begin, end); }

    void set_germline(const std::string::const_iterator &begin, const std::string::const_iterator &end)
    { read_germline_pair_.second.assign<std::string::const_iterator>(begin, end); }
